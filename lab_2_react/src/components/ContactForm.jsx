  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] w-full max-w-lg p-10 shadow-2xl relative border border-slate-200 dark:border-slate-800">
        ...
        <p className="text-slate-500 text-sm mb-8 text-center">Будь ласка, заповніть форму, і ми зв'яжемося з вами!</p>
        
        <form 
          action="https://formspree.io/f/xqegqejd" 
          method="POST" 
          className="space-y-4"
        >
          <div>
          ...
          <div>
            <label className="block text-xs font-bold uppercase text-slate-400 mb-1 ml-2">Номер телефону</label>
            <input 
              type="tel" 
              name="phone" 
              placeholder="+380..." 
